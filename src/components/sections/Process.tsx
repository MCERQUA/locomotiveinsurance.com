...
const STEPS = [
  { icon: ClipboardList, step: "01", title: "Tell Us About Your Railroad", desc: "Answer a few quick questions about your operation, passenger volume, equipment, track, and coverage history." },
  { icon: Search, step: "02", title: "Review Your Quote", desc: "We shop specialty railroad markets and present competitive options — GL, railroad liability, passenger, rolling stock, and more." },
