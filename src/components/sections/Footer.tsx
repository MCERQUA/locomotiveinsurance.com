      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 bg-forest-green rounded-md flex items-center justify-center">
                <span className="text-white font-heading font-bold text-sm">LI</span>
              </div>
              <span className="font-heading font-bold text-white text-lg">
                Locomotive<span className="text-ember-orange">Insurance</span>
              </span>
            </div>
            <p className="font-body text-sm text-white/70 leading-relaxed mb-4">
              Specialized insurance for heritage and short-line railroad operators. Licensed in all 50 states since 2005.
            </p>
          ...
          <div>
            ...
            <p className="font-body text-sm text-white/70 mb-4">Same-day quotes for railroad operators. Call or fill out our quick quote form.</p>
