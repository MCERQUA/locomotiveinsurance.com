...
import { Shield, HardHat, Wrench, Truck, CheckCircle, FileText, Umbrella, TrainTrack, TrainFront, Users, Building2, Droplet, ArrowRight } from "lucide-react";
      ...
      <div className="container-xl">
        <FadeIn>
          <div className="text-center mb-14">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl text-bark font-bold mb-4">Insurance Built for Railroads</h2>
            <p className="font-body text-muted max-w-2xl mx-auto">
              Every coverage a heritage or short-line railroad needs — from general and railroad liability to passenger, rolling stock, property, and pollution protection.
            </p>
          </div>
        </FadeIn>
