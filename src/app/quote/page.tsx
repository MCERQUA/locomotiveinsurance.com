      ...
      <main>
        <section className="bg-forest-green pt-24 pb-16">
          <div className="container-xl">
            <FadeIn>
              <h1 className="font-heading text-4xl sm:text-5xl text-white font-bold mb-4">Get a Heritage Railroad Insurance Quote</h1>
              <p className="font-body text-white/80 text-lg max-w-xl">Tell us about your railroad and we'll prepare a competitive quote — same-day turnaround.</p>
            </FadeIn>
          </div>
        </section>
                ...
                <FadeIn>
                  {submitted ? (
                    <div className="bg-white rounded-2xl border border-border p-10 text-center">
                      ...
                      <p className="font-body text-muted mb-2">We'll prepare your railroad insurance quote and be in touch today.</p>
                    ...
                    <div className="bg-white rounded-2xl border border-border p-8">
                      <h2 className="font-heading text-2xl text-bark font-bold mb-6">Railroad Insurance Quote Request</h2>
                      <form
                        name="quote"
                        method="POST"
                        data-netlify="true"
                      ...
                      >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                          {select("operationType", "Type of Railroad Operation", ["Excursion / Tourist Railroad", "Railroad Museum", "Dinner Train", "Short-Line Freight", "Locomotive Restoration Shop", "Multiple / Combined", "Other"])}
                          {select("annualRevenue", "Annual Revenue", ["Under $250K", "$250K–$500K", "$500K–$1M", "$1M–$2.5M", "$2.5M–$5M", "Over $5M"])}
                          {select("crewSize", "Employees & Volunteers", ["1 (Owner only)", "2–10", "11–25", "26–50", "51–150", "150+"])}
                        ...
                        >
                          {loading ? "Submitting..." : "Get My Railroad Insurance Quote →"}
                        </button>
                      </form>
                    </div>
                  )}
              ...
              <aside className="space-y-5">
                <FadeIn direction="left">
                  <div className="bg-forest-green rounded-2xl p-7">
                    ...
                    <p className="font-body text-white/70 text-sm mb-4">Our railroad insurance specialists are ready to quote you now.</p>
                ...
                <FadeIn direction="left" delay={0.05}>
                  <div className="bg-white rounded-2xl border border-border p-6">
                    ...
                    {["General Liability", "Railroad Liability & FELA", "Passenger Liability", "Rolling Stock & Equipment", "Commercial Property", "Pollution & Workers Comp"].map((i) => (
