...
import { ArrowRight, Shield, HardHat, Wrench, Truck, CheckCircle, FileText, Umbrella, TrainTrack, TrainFront, Users, Building2, Droplet } from "lucide-react";
...
export const metadata: Metadata = {
  title: "Heritage & Short-Line Railroad Insurance Services",
  description: `Complete insurance coverage for heritage and short-line railroads — general liability, railroad liability, passenger liability, rolling stock, commercial property, pollution liability, and workers comp. ${SITE.statesLicensed}.`,
};

const ICONS: Record<string, React.ComponentType<{ className?: string }>> = {
  Shield, HardHat, Wrench, Truck, CheckCircle, FileText, Umbrella, TrainTrack, TrainFront, Users, Building2, Droplet,
};
        ...
        <section className="bg-forest-green pt-24 pb-16">
          <div className="container-xl">
            <FadeIn>
              ...
              <h1 className="font-heading text-4xl sm:text-5xl text-white font-bold mb-4">Heritage Railroad Insurance</h1>
              <p className="font-body text-white/80 text-lg max-w-2xl">
                Every policy a heritage or short-line railroad needs — in one place, from specialists who know railroading.
              </p>
            </FadeIn>
          </div>
        </section>
