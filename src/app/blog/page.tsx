...
export const metadata: Metadata = {
  title: "Heritage Railroad Insurance Blog",
  description: `Guides on general liability, railroad liability and FELA, passenger liability, and rolling stock insurance for railroad operators. Expert advice from ${SITE.name}.`,
};
      ...
      <main>
        <section className="bg-forest-green pt-24 pb-16">
          <div className="container-xl">
            <FadeIn>
              <h1 className="font-heading text-4xl sm:text-5xl text-white font-bold mb-4">Heritage Railroad Insurance Blog</h1>
              <p className="font-body text-white/80 text-lg max-w-2xl">
                Expert guides on insurance for heritage railroads, museums, dinner trains, and short lines.
              </p>
            </FadeIn>
          </div>
        </section>
